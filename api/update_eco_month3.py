...
XLSX = BASE_DIR / "2023_10_car.xlsx"     # 파일명 맞게
SHEET = "10.연료별_등록현황"
DATE_KEY = 202310
...
print("\n[PREVIEW] 202310 서울 연료별:", picked)  # 예: {'gasoline': 1658706, 'diesel': 1008457, 'lpg': 203451, 'cng': 7799}
...
try:
    ...
    conn.commit()
    print(f"[OK] 1st_project.ice_monthly 업서트 완료:  {picked}")
